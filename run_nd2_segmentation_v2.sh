#!/bin/bash
# Run segmentation on ND2 files in parallel (v2 - with improved ND2 loading)
...
OUTPUT_DIR="/Users/csm70/Desktop/Shalem_Lab/ImageAnalysis/results/nd2_segmentation_v2_output"
...
# Run the parallel segmentation with the v2 version
...
python benchmark_optimizers_from_centroids.py \
    ...
    --output-dir "results/nd2_optimizer_benchmark_v2" \
    --trials 5

echo "Benchmark completed. Results saved to results/nd2_optimizer_benchmark_v2"