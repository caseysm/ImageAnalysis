    ...
    for i in tqdm(range(len(df_geno))):
        ...
        try:
            ...
            if T_40X >= 0:
                ...
                img_40X = isf.InSitu.Import_ND2_by_Tile_and_Well(T_40X, n_well, os.path.join(path_40X, '/mnt/isilon/shalemlab/Tutorials/Demo_In-Situ-Seq_Analysis/Data/phenotyping'))
